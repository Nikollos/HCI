...
import static at.ac.univie.cosy.hci_gruppe15.walkthisway.R.id.map;
...
public class Navi extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double [] koordinaten =intent.getDoubleArrayExtra("var_koordinaten");

        mMap = googleMap;
        // Add a marker in Sydney and move the camera
        LatLng sydney = new LatLng(koordinaten[0],koordinaten[1]);
